                ...
                <div class="card bg-white">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <form action="{{ route('edit.produk', $data->id_produk)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-6">
                                                ...
                                                <select class="form-control" id="id_kategori_produk" name="id_kategori_produk">
                                                    @foreach ($kategori as $jenis)
                                                        <option value="{{ $jenis->id_kategori_produk }}"
                                                            {{ $jenis->id_kategori_produk == $data->id_kategori_produk ? 'selected' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <img src="{{ asset('/image/produk/' . $data->foto_produk) }}"
                                                                alt="img" width="150px">
                                                    </td>
                                                    <td>
                                                    {{-- Gambar Baru --}}
